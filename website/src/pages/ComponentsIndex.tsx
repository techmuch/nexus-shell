...
const CATEGORY_BLURB: Record<string, string> = {
  Shell: 'The assembled application frame.',
  Chrome: 'The bars and rails that surround your content.',
    ...
    <article>
      <header className="mb-10">
        ...
        <P className="mt-3 max-w-2xl">
          {total} components. Every one is pure and prop-driven — no global state, no
          registry lookups. Each page has live examples you can interact with, the exact
