...
import '../../../src/styles/flexlayout-theme.css';
...
import { useLayoutStore, dialogueMappingLayoutJson } from '../../../src/core/services/LayoutService';
import { 
  Settings, 
  Circle
} from 'lucide-react';
...
export const NexusWorkspaceShell: React.FC<NexusWorkspaceShellProps> = ({
  ...
  return (
    <div className={cn(
      ...
      {/* 1. Header Menubar */}
      <ConnectedMenuBar 
        title={<AppTitle title="NEXUS RESEARCH" subtitle="Knowledge Modeler & Argumentation Workbench" />}
        right={
          <div className="flex items-center space-x-3 select-none z-50">
            <ConnectedThemeSwitcher />
            <ConnectedUserProfile showName={false} />
          </div>
        }
      />
