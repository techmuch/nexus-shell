import { IPlugin } from '../../../src/core/registry/PluginRegistry';
...
// Import Widgets
import { WikiNavigator } from '../wiki/components/WikiNavigator';
import { WikiEditor } from '../wiki/components/WikiEditor';
import { WikiHistorySidebar } from '../wiki/components/WikiHistorySidebar';
import { AiCoWriterWorkspace } from '../wiki/components/AiCoWriterWorkspace';
import { WikiChatWidget } from '../wiki/components/WikiChatWidget';
import { SemanticLinkMapper } from '../wiki/components/SemanticLinkMapper';
