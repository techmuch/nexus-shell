...
## Acceptance criteria
- [x] Create a `DialogueMappingComposition.stories.tsx` story demonstrating the unified three-panel workbench.
- [x] Write a Playwright integration test at `tests/composition.spec.ts` asserting interactive data synchronization between the tabs.
- [x] Run the Playwright test successfully.
