...
## Acceptance criteria
- [x] Install devDependencies: `vitest`, `@testing-library/react`, `@testing-library/jest-dom`.
- [x] Create `vitest.config.ts` configuration.
- [x] Add `npm run test` script running `vitest run`.
- [x] Write unit tests for Zustand stores ensuring they pass typechecking and runtime validation.
